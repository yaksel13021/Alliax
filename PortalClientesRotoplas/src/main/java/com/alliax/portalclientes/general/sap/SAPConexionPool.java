...
@Service("sapConexionPool")
public class SAPConexionPool {
    ...
    private static final Logger logger = Logger.getLogger(SAPConexionPool.class);
    
    private final String SAP_POOL = "RtpClientesSapPool";
     ...
     * 
     */
	public SAPConexionPool() throws Exception {
    ...
    private void addClientPool() throws ClassNotFoundException, Exception{
        try {            
            ...
            Properties sapData = this.getPropertie("SRMPRD");  
	...
	private Properties getPropertie(String dest) throws ClassNotFoundException, Exception {
        ...
        try {
            fis = SAPConexionPool.class.getResourceAsStream("/META-INF/"+ cfgFile);
            prop.load(fis);
